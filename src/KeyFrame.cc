...
void KeyFrame::UpdateBestCovisibles()
{
    ...
    //cerr<<"mConnectedKeyFrameWeights.size()"<<mConnectedKeyFrameWeights.size()<<endl;
...
void KeyFrame::UpdateConnections(bool upParent)
{
    ...
    //cerr<<"KFcounter.size()"<<KFcounter.size()<<endl;
...
void KeyFrame::PreSave(set<KeyFrame*>& spKF,set<MapPoint*>& spMP, set<GeometricCamera*>& spCam)
{
    ...
    //cerr<<"N"<<N<<"mvBackupMapPointsId.size()"<<mvBackupMapPointsId.size()<<endl;
}
